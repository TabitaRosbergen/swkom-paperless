...
public class DocumentsStoragepathEntity {
    ...
    private Set<DocumentsDocumentEntity> storagePathDocumentsDocumentEntities;
    ...
    public Set<DocumentsDocumentEntity> getStoragePathDocumentsDocuments() {
        return storagePathDocumentsDocumentEntities;
    }

    public void setStoragePathDocumentsDocuments(
            final Set<DocumentsDocumentEntity> storagePathDocumentsDocumentEntities) {
        this.storagePathDocumentsDocumentEntities = storagePathDocumentsDocumentEntities;
    }
