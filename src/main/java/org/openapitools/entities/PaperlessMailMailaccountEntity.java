...
public class PaperlessMailMailaccountEntity {
    ...
    private Set<PaperlessMailMailruleEntity> accountPaperlessMailMailruleEntities;
    ...
    public Set<PaperlessMailMailruleEntity> getAccountPaperlessMailMailrules() {
        return accountPaperlessMailMailruleEntities;
    }

    public void setAccountPaperlessMailMailrules(
            final Set<PaperlessMailMailruleEntity> accountPaperlessMailMailruleEntities) {
        this.accountPaperlessMailMailruleEntities = accountPaperlessMailMailruleEntities;
    }
