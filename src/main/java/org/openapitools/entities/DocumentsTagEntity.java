...
public class DocumentsTagEntity {
    ...
    private Set<DocumentsDocumentTagsEntity> tagDocumentsDocumentTagsEntities;
    ...
    public Set<DocumentsDocumentTagsEntity> getTagDocumentsDocumentTagses() {
        return tagDocumentsDocumentTagsEntities;
    }

    public void setTagDocumentsDocumentTagses(
            final Set<DocumentsDocumentTagsEntity> tagDocumentsDocumentTagsEntities) {
        this.tagDocumentsDocumentTagsEntities = tagDocumentsDocumentTagsEntities;
    }

    public Set<PaperlessMailMailruleAssignTagsEntity> getTagPaperlessMailMailruleAssignTagses() {
        return tagPaperlessMailMailruleAssignTagsEntities;
    }

    public void setTagPaperlessMailMailruleAssignTagses(
            final Set<PaperlessMailMailruleAssignTagsEntity> tagPaperlessMailMailruleAssignTagsEntities) {
